...
# This class contains all S3 bucket related method/functions which are required for any pipeline project. 
# For our sign language project we will be only using method/function  upload_file .
# Rest function/method are for future references.
...
class S3Operation:
    ...
    # read_object is a static method which 
    @staticmethod
    ...
    #This method gets the bucket object based on the bucket_name and returns the bucket object
    ...
    #This method checks if model is present in s3 bucket and return True or False accordingly
    ...
    # bucket_name   = s3 bucket name  in our case "sign-lang23-bucket" 
    def upload_file(self,from_filename: str,to_filename: str,bucket_name: str,remove: bool = True,) -> None:
        ...
        try:
            ...
            # by default we will be removing/replacing the best.pt model everytime our model runs.
            if remove is True:
