...
# default route to launch index.html for object detection
@app.route("/")
def home():
...
def predictRoute():
    try:
        ...
        # ideally we should be predicting with best.pt, but best.pt is only trained with 1 epoch for faster completion of training 
        # so we will be predicting with my_model.pt kept in yolov5 folder which is trained with 300 epochs
...
# This is for live camera prediction
